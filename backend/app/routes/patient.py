...
from app.models import PatientProfileResponse, PatientProfileUpdate, RoleEnum
...
async def update_my_patient_profile(
    ...
    result = await db["patient_profiles"].find_one_and_update(
    ...
    return PatientProfileResponse.model_validate(serialize_document(result))
